...
export default function Orders() {
  ...
  const data = useSelector((state) => state.ShoppingReducers.orders);
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(AllProducts());
  }, [dispatch]);
  ...
  return (
    <Box sx={{ width: "100%" }}>
    <div><input type="text" name="" id="" placeholder="Search the orders by title" style={{padding:"10px",outline:"0",borderRadius:"5px",margin:"10px",width:"500px"}} 
